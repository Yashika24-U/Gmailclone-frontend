    ...
    return (
        <Box style={openDrawer ? { marginLeft: 250, width: 'calc(100% -250px' } : { width: '100%' }}>
            <Box style={{ padding: '20px 10px 0px 10px', display: 'flex', alignItems: 'center' }}>
                ...
                {/* in the above event e we will get either true or false */}
                <DeleteOutline onClick={(e) => deleteSelectedEmails(e)} />

            </Box>
            <List>
                {
                    // if  getEmailsService is undefined it will not go to response
                    // supose undefined.response we get error
